...
$.fn.AdminSettings = function(t) {
    ...
    t), a = {
        ...
        ManageThemeBackground: function() {
            ...
            null != (a = t.NavbarBg) && "" != a ? ($("#" + i + " .topbar .navbar-collapse").attr("data-navbarbg", a), $("#" + i + " .topbar").attr("data-navbarbg", a), $("#" + i).attr("data-navbarbg", a)) : ($("#" + i + " .topbar .navbar-collapse").attr("data-navbarbg", "skin1"), $("#" + i + " .topbar").attr("data-navbarbg", "skin1"), $("#" + i).attr("data-navbarbg", "skin1"))
        },
        ManageSidebarType: function() {
            ...
            case "full":
                ...
                $(".sidebartoggler").on("click", function() {
                    ...
                    $("#main-wrapper").hasClass("mini-sidebar") ? ($(".sidebartoggler").prop("checked", !0), $("#main-wrapper").attr("data-sidebartype", "mini-sidebar")) : ($(".sidebartoggler").prop("checked", !1), $("#main-wrapper").attr("data-sidebartype", "full"))
                });
                break;
            case "mini-sidebar":
...
$(function() {
    ...
    $(document).on("keypress", ".chat-windows .user-chat .chat-footer input", function(a) {
        var e;
        13 == a.keyCode && (e = $(this).attr("data-user-id"), a = msg_sent(a = $(this).val()), $(".chat-windows #user-chat" + e + " .chat-body .chat-list").append(a), $(this).val(""), $(this).focus()),
