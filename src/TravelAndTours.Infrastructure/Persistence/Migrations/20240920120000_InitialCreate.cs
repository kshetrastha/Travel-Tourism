...
public partial class InitialCreate : Migration
{
    protected override void Up(MigrationBuilder migrationBuilder)
    {
        ...
        migrationBuilder.CreateTable(
            ...
            constraints: table =>
            {
                table.PrimaryKey("PK_ExpeditionCategories", x => x.Id);
                table.ForeignKey(
                    name: "FK_ExpeditionCategories_ExpeditionCategories_ParentCategoryId",
                    column: x => x.ParentCategoryId,
                    principalTable: "ExpeditionCategories",
                    principalColumn: "Id",
        ...
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                ...
                Slug = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: false),
                ShortTitle = table.Column<string>(type: "character varying(120)", maxLength: 120, nullable: true),
                ...
                BestSeason = table.Column<string>(type: "character varying(120)", maxLength: 120, nullable: false),
                GroupSizeMin = table.Column<int>(type: "integer", nullable: true),
                GroupSizeMax = table.Column<int>(type: "integer", nullable: true),
                StartingPoint = table.Column<string>(type: "character varying(120)", maxLength: 120, nullable: true),
                EndingPoint = table.Column<string>(type: "character varying(120)", maxLength: 120, nullable: true),
            ...
            constraints: table =>
            {
                ...
                table.ForeignKey(
                    name: "FK_Expeditions_ExpeditionCategories_CategoryId",
        ...
        migrationBuilder.CreateTable(
            ...
            constraints: table =>
            {
                table.PrimaryKey("PK_ExpeditionFacts", x => x.Id);
                table.ForeignKey(
                    name: "FK_ExpeditionFacts_Expeditions_ExpeditionId",
        ...
        migrationBuilder.CreateTable(
            name: "ExpeditionVariants",
            columns: table => new
            {
                Id = table.Column<int>(type: "integer", nullable: false)
                    .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                ExpeditionId = table.Column<int>(type: "integer", nullable: false),
                VariantType = table.Column<string>(type: "character varying(30)", maxLength: 30, nullable: false),
                TitleOverride = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: true),
                PriceFrom = table.Column<decimal>(type: "numeric(18,2)", nullable: false),
                InclusionsOverrideMarkdown = table.Column<string>(type: "text", nullable: true),
                ExclusionsOverrideMarkdown = table.Column<string>(type: "text", nullable: true),
                IsActive = table.Column<bool>(type: "boolean", nullable: false, defaultValue: true),
                CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false, defaultValueSql: "timezone('utc', now())"),
                UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true)
            },
            constraints: table =>
            {
                table.PrimaryKey("PK_ExpeditionVariants", x => x.Id);
                table.ForeignKey(
                    name: "FK_ExpeditionVariants_Expeditions_ExpeditionId",
                    column: x => x.ExpeditionId,
                    principalTable: "Expeditions",
                    principalColumn: "Id",
                    onDelete: ReferentialAction.Cascade);
        ...
        migrationBuilder.CreateTable(
            ...
            constraints: table =>
            {
                ...
                table.ForeignKey(
                    name: "FK_FaqItems_Expeditions_ExpeditionId",
                    column: x => x.ExpeditionId,
                    principalTable: "Expeditions",
                    principalColumn: "Id",
                    onDelete: ReferentialAction.Cascade);
        ...
        migrationBuilder.CreateTable(
            ...
            constraints: table =>
            {
                ...
                table.ForeignKey(
                    name: "FK_FixedDepartures_ExpeditionVariants_VariantId",
                    column: x => x.VariantId,
                    principalTable: "ExpeditionVariants",
                    principalColumn: "Id",
        ...
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                ...
                Meals = table.Column<string>(type: "character varying(120)", maxLength: 120, nullable: true),
        ...
        migrationBuilder.CreateTable(
            ...
            constraints: table =>
            {
                ...
                table.ForeignKey(
                    name: "FK_MediaAssets_Expeditions_ExpeditionId",
                    column: x => x.ExpeditionId,
                    principalTable: "Expeditions",
                    principalColumn: "Id",
                    onDelete: ReferentialAction.Cascade);
        ...
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                Id = table.Column<int>(type: "integer", nullable: false)
                    .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                ExpeditionId = table.Column<int>(type: "integer", nullable: false),
                ReviewerName = table.Column<string>(type: "character varying(120)", maxLength: 120, nullable: true),
            ...
            constraints: table =>
            {
                ...
                table.ForeignKey(
                    name: "FK_Reviews_Expeditions_ExpeditionId",
                    column: x => x.ExpeditionId,
                    principalTable: "Expeditions",
                    principalColumn: "Id",
                    onDelete: ReferentialAction.Cascade);
        ...
        migrationBuilder.CreateIndex(
            name: "IX_ExpeditionCategories_ParentCategoryId",
            table: "ExpeditionCategories",
            column: "ParentCategoryId");

        migrationBuilder.CreateIndex(
            name: "IX_ExpeditionCategories_Slug",
            table: "ExpeditionCategories",
            column: "Slug",
            unique: true);

        migrationBuilder.CreateIndex(
            name: "IX_ExpeditionFacts_ExpeditionId",
            table: "ExpeditionFacts",
            column: "ExpeditionId");

        migrationBuilder.CreateIndex(
            name: "IX_ExpeditionVariants_ExpeditionId",
            table: "ExpeditionVariants",
            column: "ExpeditionId");

        migrationBuilder.CreateIndex(
            name: "IX_Expeditions_CategoryId",
            table: "Expeditions",
            column: "CategoryId");
        ...
        migrationBuilder.CreateIndex(
            name: "IX_FixedDepartures_VariantId",
            table: "FixedDepartures",
            column: "VariantId");
        ...
        migrationBuilder.CreateIndex(
            name: "IX_MediaAssets_ExpeditionId",
            table: "MediaAssets",
            column: "ExpeditionId");

        migrationBuilder.CreateIndex(
            name: "IX_Reviews_ExpeditionId",
            table: "Reviews",
            column: "ExpeditionId");
    }
